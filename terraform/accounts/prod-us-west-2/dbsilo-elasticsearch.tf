...
module "dbsilo2-elasticsearch" {
    ...
    service = "dbsilo2-elasticsearch"
    env = "${var.cluster_name}"
    datadog_api_key = "${var.datadog_api_key}"

    name = "${var.cluster_name}-dbsilo2-elasticsearch"
    version = "v034"
    ami_id = "ami-b258c5d2" # elasticsearch 2.4.4
    instance_type = "m3.xlarge"
    min_size = 0
...
module "dbsilo3-elasticsearch" {
    ...
    service = "dbsilo3-elasticsearch"
    env = "${var.cluster_name}"
    datadog_api_key = "${var.datadog_api_key}"

    name = "${var.cluster_name}-dbsilo3-elasticsearch"
    version = "v034"
    ami_id = "ami-b258c5d2" # elasticsearch 2.4.4
    instance_type = "m3.xlarge"
    min_size = 0
